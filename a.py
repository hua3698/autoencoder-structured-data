...
datasets = ['kddcup-land_vs_portsweep']
...
for idx, dataset in enumerate(datasets):
  ...
  for times in range(1,6):
    ...
    # ae
    x_train_encoded, x_test_encoded = train_sae_210(x_train, x_test)
    ...
    x_train_smote_encoded, x_test_smote_encoded = train_sae_210(x_train_smote, x_test)
...
for idx, dataset in enumerate(datasets):
  ...
  for times in range(1,6):
    ...
    # ae
    x_train_encoded, x_test_encoded = train_sae_220(x_train, x_test)
    ...
    # smote+ae
    x_train_smote, y_train_smote = SMOTE(random_state=42).fit_resample(x_train, y_train)
    x_train_smote_encoded, x_test_smote_encoded = train_sae_220(x_train_smote, x_test)
