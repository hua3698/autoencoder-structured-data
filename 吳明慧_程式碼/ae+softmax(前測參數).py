...
for ff in fliename:
  ...
  ansc45knn.to_csv('AE/(ans)ae(前測)(2-1).csv',index=False,encoding='utf-8')
...
for ff in fliename:
  ...
  ansc45knn=ansc45knn.append(new)
  ansc45knn.to_csv('AE/(ans)ae(前測)(2-2).csv',index=False,encoding='utf-8')
...
for ff in fliename:
  ...
  ansc45knn=ansc45knn.append(new)
  ansc45knn.to_csv('AE/(ans)ae(前測)(2-3).csv',index=False,encoding='utf-8')
...
for ff in fliename:
  ...
  ansc45knn=ansc45knn.append(new)
  ansc45knn.to_csv('AE/(ans)ae(前測)(2-4).csv',index=False,encoding='utf-8')
...
for ff in fliename:
  ...
  ansc45knn=ansc45knn.append(new)
  ansc45knn.to_csv('AE/(ans)ae(前測)(3-1).csv',index=False,encoding='utf-8')
...
for ff in fliename:
  ...
  ansc45knn=ansc45knn.append(new)
  ansc45knn.to_csv('AE/(ans)ae(前測)(3-2).csv',index=False,encoding='utf-8')
...
for ff in fliename:
  ...
  ansc45knn=ansc45knn.append(new)
  ansc45knn.to_csv('AE/(ans)ae(前測)(3-3).csv',index=False,encoding='utf-8')
...
for ff in fliename:
  ...
  ansc45knn=ansc45knn.append(new)
  ansc45knn.to_csv('AE/(ans)ae(前測)(4-1).csv',index=False,encoding='utf-8')
...
for ff in fliename:
  ...
  ansc45knn=ansc45knn.append(new)
  ansc45knn.to_csv('AE/(ans)ae(前測)(4-2).csv',index=False,encoding='utf-8')
...
for ff in fliename:
  ...
  ansc45knn=ansc45knn.append(new)
  ansc45knn.to_csv('AE/(ans)ae(前測)(5-1).csv',index=False,encoding='utf-8')
...
for ff in fliename:
  ...
  ansc45knn=ansc45knn.append(new)
  ansc45knn.to_csv('AE/(ans)ae(前測)(6-1).csv',index=False,encoding='utf-8')
...
for ff in fliename:
  ...
  ansc45knn=ansc45knn.append(new)
  ansc45knn.to_csv('AE/(ans)ae(前測)(7-1).csv',index=False,encoding='utf-8')